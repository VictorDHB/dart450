...
// This part is the character's mechanism. You can change the speed and the jump height.
...
// This moves to the next stage when the yellow box is hit.
...
// When the character climbs on a ladder
...
// When the character opens a door, it transports to another door.
...
// This part is the camera that follows the player.
...
// This part loads all the game assets.

Q.loadTMX("level1.tmx, level2.tmx, collectables.json, doors.json, enemies.json, fall.mp3, fire.mp3, jump.mp3, heart.mp3, hit.mp3, coin.mp3, player.json, player.png", function() {
